...
public class NetworkClient {
    ...
    private static Cache provideCache() {
        Cache cache = null;
        try {
            cache = new Cache(new File(FoodyApplication.getCacheDirectory(), "http-cache"), CACHE_SIZE);
        } catch (Exception ex) {
    ...
    public static Interceptor provideOfflineCacheInterceptor(){
        return new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                if(!FoodyApplication.getInstance().isNetworkOnline()){
                    CacheControl cacheControl = new CacheControl.Builder()
    ...
    public static GoogleMapService provideGoogleMapService(){
        return provideRetrofit(BASE_URL).create(GoogleMapService.class);
    }
