...
public class CircleImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mBorderColor = a.getColor(R.styleable.CircleImageView_color, DEFAULT_BORDER_COLOR);
    ...
    protected void onDraw(Canvas canvas) {
        if (getDrawable() != null) {
            canvas.drawCircle((float) (getWidth() / COLORDRAWABLE_DIMENSION), (float) (getHeight() / COLORDRAWABLE_DIMENSION), this.mDrawableRadius, this.mBitmapPaint);
            if (this.mBorderWidth != 0) {
                canvas.drawCircle((float) (getWidth() / COLORDRAWABLE_DIMENSION), (float) (getHeight() / COLORDRAWABLE_DIMENSION), this.mBorderRadius, this.mBorderPaint);
            }
        }
    }
